...
net_test = [MobileNetV2_Custom_Distillation_advanced(width_mult=0.25),
            MobileNetV2_Custom_Distillation_advanced(width_mult=0.3334)]

name = [
    "MobileNetV2_custom_0.25_1_disti",
    "MobileNetV2_custom_0.334_1_disti",
]
